...
cp html_ton/css /var/www/html/
cp html_ton/fonts /var/www/html/
cp html_ton/image /var/www/html/
cp html_ton/notifications /var/www/html/
cp html_ton/sounds /var/www/html/
